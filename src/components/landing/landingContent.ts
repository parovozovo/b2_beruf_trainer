...
export const LANDING_TRANSLATIONS: Record<LandingLang, LandingTranslation> = {
  ua: {
    ...
    hero: {
      preHeadline: '🇩🇪 Підготовка до Deutsch-Test für den Beruf B2 (DTB)',
      ...
      trustText: 'Формат завдань на 100% відповідає стандартам реального іспиту DTB B2',
      badge1Val: '12',
    ...
    faq: {
      ...
      q1: 'Чи підходять ваші тести для офіційного іспиту DTB B2?',
    ...
    footer: {
      ...
      disclaimer: 'Платформа створена для ефективної та самостійної підготовки до іспиту DTB B2.',
    },
  },
  de: {
    nav: {
    ...
    hero: {
      preHeadline: '🇩🇪 Vorbereitung auf den Deutsch-Test für den Beruf B2 (DTB)',
      ...
      trustText: 'Aufgabenformat entspricht zu 100% den Standards der offiziellen DTB B2 Prüfung',
      badge1Val: '12',
    ...
    faq: {
      ...
      q1: 'Sind die Tests mit den offiziellen DTB B2 Prüfungen kompatibel?',
    ...
    footer: {
      ...
      disclaimer: 'Entwickelt zur gezielten und effektiven Vorbereitung auf den Deutsch-Test für den Beruf B2 (DTB).',
    },
  },
  en: {
    nav: {
    ...
    hero: {
      preHeadline: '🇩🇪 German B2 Professional Exam Prep (DTB)',
      ...
      trustText: '100% aligned with official DTB B2 exam standards',
      badge1Val: '12',
  ...
  tr: {
    ...
    hero: {
      preHeadline: '🇩🇪 Deutsch-Test für den Beruf B2 (DTB) Hazırlık',
      ...
      trustText: 'Soru formatı %100 resmi DTB B2 sınav standartlarına uygundur',
      badge1Val: '12',
    ...
    faq: {
      ...
      q1: 'Testler resmi DTB B2 sınavlarına uygun mu?',
    ...
    footer: {
      ...
      disclaimer: 'Bireysel DTB B2 sınav hazırlığı için geliştirilmiştir.',
    },
  },
  es: {
    nav: {
    ...
    hero: {
      preHeadline: '🇩🇪 Preparación para Deutsch-Test für den Beruf B2 (DTB)',
      ...
      trustText: 'Formato 100% adaptado a los estándares oficiales de DTB B2',
      badge1Val: '12',
    ...
    faq: {
      ...
      q1: '¿Son compatibles los exámenes con las pruebas oficiales de DTB B2?',
    ...
    footer: {
      ...
      disclaimer: 'Diseñado para la preparación autodidacta del examen DTB B2.',
    },
  },
  ru: {
    nav: {
    ...
    hero: {
      preHeadline: '🇩🇪 Подготовка к экзамену Deutsch-Test für den Beruf B2 (DTB)',
      ...
      trustText: 'Формат заданий на 100% соответствует стандартам реального экзамена DTB B2',
      badge1Val: '12',
    ...
    faq: {
      ...
      q1: 'Подходят ли ваши тесты для официального экзамена DTB B2?',
    ...
    footer: {
      ...
      disclaimer: 'Создано для эффективной самостоятельной подготовки к экзамену DTB B2.',
    },
  },
};

    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="relative overflow-hidden rounded-3xl glass-panel p-8 border border-indigo-500/30">
        ...
        <div className="relative z-10 space-y-4 max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-indigo-500/20 text-indigo-900 dark:text-indigo-300 rounded-full text-xs sm:text-sm font-extrabold border border-indigo-500/30">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            ...
            <button
              ...
              className="px-6 py-3.5 glass-card hover:bg-slate-800 text-slate-900 dark:text-slate-200 font-extrabold rounded-2xl border border-slate-400 dark:border-slate-700/60 transition-all text-xs sm:text-sm flex items-center gap-2"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-slate-800 dark:text-slate-300 leading-relaxed font-semibold">

      ...
      hoeren_1: [
        {
          ...
          scriptText: `Sprachnachricht 1: Hallo Frau Hoffmann, hier spricht Thomas vom Fuhrpark. Der Dienstwagen VW Passat steht frisch gereinigt auf Stellplatz 12. Die Schlüssel liegen beim Empfang.\n\nSprachnachricht 2: Guten Tag, hier ist die Personalabteilung. Wir erinnern alle Kolleginnen und Kollegen an die Abgabe der Stundenzettel für diesen Monat bis morgen 12 Uhr.`,
          questions: [
            ...
            { id: 26, type: 'richtig_falsch', questionText: 'Die Nachricht kommt von der Buchhaltung.', correct: 'falsch' },
            { id: 27, type: 'choice', questionText: 'Wer schickte die Ersterinnerung zum Dienstwagen?', options: ['Thomas vom Fuhrpark', 'Die Werkstatt', 'Frau Hoffmann'], correct: 0 }
          ]
        }
      ],
      hoeren_2: [
